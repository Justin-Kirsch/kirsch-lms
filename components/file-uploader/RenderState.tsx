...
export function RenderErrorState() {
    return (
        <div className="text-center">
            ...
            <p className="text-xs mt-1 text-muted-foreground">Something went wrong. Please try again.</p>
...
export function RenderUploadingState({ progress, file }: { progress: number, file: File }) {
    return (
        <div className="text-center flex flex-col justify-center items-center">
            ...
            <p className="mt-2 text-sm font-medium text-foreground">File is being uploaded...</p>
