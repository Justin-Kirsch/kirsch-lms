...
import { ArrowRight, Eye, MoreVertical, Pencil, School, TimerIcon, Trash2, Wallet } from "lucide-react";
...
export function AdminCourseCard({data}: iAppProps) {
    ...
    return(
        <Card className="group relative py-0 gap-0 max-w-140">
            {/* absolute dropdown */}
            ...
            <CardContent className="flex flex-col p-4 gap-2">
                ...
                <div className="mt-4 flex items-center gap-x-5 justify-around">
                    ...
                    <div className="flex items-center gap-x-2">
                        <School className="size-8 p-1 rounded-md text-primary bg-primary/10" />
                        <p className="text-sm text-muted-foreground">{data.level}</p>
                    </div>
                    <div className="flex items-center gap-x-2">
                        <Wallet className="size-8 p-1 rounded-md text-primary bg-primary/10" />
